...
- Useful Tools
  ...
  - [LTI Expert GPT](https://chat.openai.com/g/g-l3Uw5D4re-lti-expert-gpt) - An AI trained on LTI 1.3 and related specs, provides easy explanations and code generation. This requires a ChatGPT subscription, free otherwise. Initial testing have given mixed results. The advice is to use it as exploration only, not as a substitute for the actual specifications and related implementation guides.
